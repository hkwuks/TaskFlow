...
| --- | --- | --- | --- | --- | --- |
| repository-guidance | `README.md` | design,roadmap | yes | 2026-09-13 | ready |
| repository-guidance | `README.zh-CN.md` | design,roadmap | yes | 2026-09-13 | ready |
| repository-rule | `LICENSE` | all | yes | 2026-09-13 | ready |
| repository-rule | `CONTRIBUTING.md` | code,commit,pr,release | yes | 2026-09-13 | ready |
